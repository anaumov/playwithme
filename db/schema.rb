...
ActiveRecord::Schema.define(version: 20140901044239) do
  ...
  add_index "invites", ["jam_id"], name: "index_invites_on_jam_id", using: :btree
  add_index "invites", ["receiver_id"], name: "index_invites_on_receiver_id", using: :btree
